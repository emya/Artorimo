...
class IconOrder(models.Model):
    ...
    hair_filter = models.IntegerField()
    bang = models.IntegerField()
    bang_filter = models.IntegerField()
    side = models.IntegerField()
    side_filter = models.IntegerField()
    eyes = models.IntegerField()
    eyes_filter = models.IntegerField()
    eyebrows = models.IntegerField()
    eyebrows_filter = models.IntegerField()

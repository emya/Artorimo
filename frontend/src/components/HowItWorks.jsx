...
class HowItWorks extends Component {
  ...
  <div>
    ...
    <h2>How It Works</h2>
      ...
      <br/>
      <p>※<a href="https://ohcheestudio.com/register">ご登録</a>いただいた場合、全てのお仕事において弊社を通していただく必要はなく、海外のクライアントの場合のみ等、必要に応じてご利用いただけます。<br/>
      また、独占契約ではないため、他のアーティストグループとの併用も可能です。</p>


      <h3>サービス使用料</h3>
      <ul>
        <li>イラストレーター様が直接お仕事を受注した場合は報酬の10%、弊社がご紹介した場合は20%をエージェントフィーとして頂きます。</li>
        <li>イラストレーター様には上記フィーを差し引いた上で報酬を入金いたします。</li>
        <li>クライアントが海外の場合（報酬が外貨）はクライアントが入金した際の為替レートを使用して最終入金額が計算されます。</li>
        <li>そのほか初期費用や月額のプラットフォーム使用料は一切発生いたしません。</li>
      </ul>

...
class HowItWorks extends Component {
  ...
  <div>
    ...
    <h2>How It Works</h2>
      ...
      <ol>
        <li>イラストレーター様が仕事を受注</li>
        <li>クライアントからのメールもしくはSNS上の依頼メッセージを弊社に転送</li>
        <li>弊社による依頼内容確認及び報酬の交渉</li>
        <li>クライアントより弊社へ仮入金</li>
        <li>イラストレーター様の作業開始</li>
        <li>弊社を通してクライアントとの修正作業</li>
        <li>最終版を納品後、弊社からイラストレーター様へ報酬の入金</li>
      </ol>

      <br/>
      <p><a href="https://ohcheestudio.com/register">ご登録</a>いただいた場合、全てのお仕事において弊社を通していただく必要はなく、海外のクライアントの場合のみ、等必要に応じてご利用いただけます。</p>
      ...
      <ol>
        ...
        <li>解約は可能ですか？
          <ul><li>十分なサポートが出来るよう努めさせていただきますが、万が一必要ないと感じた場合の退会はもちろん可能です。</li></ul>
        </li>
      </ol>
